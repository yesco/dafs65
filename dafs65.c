...
word dafsmkdisk(int drive, int heads, int tracks, int sectors, char* name) {
  ...
  // 
  // • A signature of 8 bytes in length: ORICDISK
  // • Number of faces (32 bits)
  // • Number of tracks (32 bits)
  // • Number of sectors (32 bits)
  // • The rest of the header contains unused data.
  // 
