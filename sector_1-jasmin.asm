...
; FDC registers
FDC_command_register=		$03f4
FDC_status_register=		$03f4
FDC_track_register=		$03f5
FDC_sector_register=		$03f6
FDC_data=			$03f7

FDC_flags=			$03f8	; Only bit 0: side select
; DRQ is not readable in any address other than corresponding bit (1) in STATUS register
;#define FDC_drq                 	$03FC 	

FDC_ovl_control=         	$03FA
FDC_rom_control=         	$03FB
...
retry_counter		.res 1	; Number of attempts at loading data (ie: not quite clear what happens when this fails...)	
...
.org $400
	...
	.byte $00,$00,$00,$00,$00,$20,$20,$20,$20,$20,$20,$20,$20
	.byte $00,$00,$03,$00,$00,$00,$01,$00,$53,$45,$44,$4F,$52,$49,$43,$20
...
sector_counter		.byte (($FFFF-FLOPPY_LOADER_ADDRESS)+1)/256
